...
export default function ProjectManager() {
  ...
  const data = [
    { formTitle: "Question Name", titleKey: "title" },
    { name: "questionName", label: "Question Name", type: "text" },
  ]
  return (
    <div>
      <Home />
      <Card className={classes.root} variant="outlined">
        <Typography variant="h6" noWrap className={classes.questionTitle}>
          Question Manager
        </Typography>
        <Grid container style={{ display: "flex", justifyContent: "center" }}>
          ...
          {popUpOpen && <CustomForm openPopUp={open} closePopup={handleClose} data={data} />}
        </Grid>
        {/* <Dialog
          open={open}
          onClose={handleClose}
        ...
        >
          <DialogTitle id="form-dialog-title">Question Manager</DialogTitle>
          <DialogContent>
